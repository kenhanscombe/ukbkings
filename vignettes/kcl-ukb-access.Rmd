...
**Important.** The ukbkings package only works on a Rosalind UKB project directory that has been setup to use the package. See vignette("Setup UKB project on Rosalind") or [read the article on the package webpage](https://kenhanscombe.github.io/ukbkings/). NB. This step is typically run once, by the person who manages UKB data on Rosalind.
