...
#### Add softlinks to sample information and relatedness files

Put the downloaded sample information files (.fam and .sample)
and relatedness file (*rel*.dat/.txt) into raw/. Create softlinks to 
these project-specific files in genotyped/ and imputed/ (**Figure 3**).
...
**Figure 3** Project-specific sample information  and relatedness softlinks
