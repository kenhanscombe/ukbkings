...
wget https://raw.githubusercontent.com/kenhanscombe/ukbkings/link_genetics/project.py
chmod +x project.py
...
and include softlinks to the shared UKB genotyped and imputed genetic
data on Rosalind.
...
softlinks in genotyped/ and imputed/, and output
information is written to log/ (**Figure 2**).
...
**Figure 2** Phenotype data and genetic data softlinks

<br>

#### Add softlinks to sample information files

Put the downloaded sample information files (.fam and .sample)
into raw/. Create softlinks to these project-specific files in
genotyped/ and imputed/ respectively (**Figure 3**).

```{bash}
./link.py -p <project_id> -f <path_to_fam_file> -s <path_to_sample_file>
```
...
**Figure 3** Project-specific sample information softlinks
