...
[3. Munge the UKB data]  
[4. Add symlinks to sample information and relatedness files]  
[5. Access the data with ukbkings]  
[6. Additional withdrawals]  
[7. Updates to phenotype data]
...
wget -O project.py https://raw.githubusercontent.com/kenhanscombe/ukbkings/master/project.py
chmod +x project.py
...
into raw/. If the key file for your genetic data is ukb.key, from raw/: `../resources/ukgene [cal/imp] -c1 -m -aukb.key` for sample information files; and `../resources/ukgene rel -aukb.key` for the relatedness file.
...
```{bash}
./link.py -f <fam_file_name> -s <sample_file_name> -r <relatedness_file_name>
```
